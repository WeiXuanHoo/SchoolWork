<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Passport.aspx.cs" Inherits="SchoolInfo.UI.Passport" %>
...
<body>
    ...
    <div class="common-title">Passport</div>
    <form id="form" runat="server">
        <div class="form-container">
            ...
            <div class="form-line">
                <div class="form-name">Passport Type:</div>
                <asp:DropDownList ID="txtType" class="form-input" runat="server">
                    <asp:ListItem>Updating</asp:ListItem>
                    <asp:ListItem>Losing</asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="form-line">
                <div class="form-name">Passport Image:</div>
                <asp:FileUpload ID="txtUpload" class="form-input" runat="server" />
            </div>
            <div class="form-line">

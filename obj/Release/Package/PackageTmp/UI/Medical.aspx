<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Medical.aspx.cs" Inherits="SchoolInfo.UI.Medical" %>
...
<body>
    ...
    <!-- Common Title -->
    <div class="common-title">Medical List</div>
            ...
            if (dtDataList != null)
            {
                for (int i = 0; i < dtDataList.Rows.Count; i++)
                {
                    ...
                    <div class="content-item">
                        <img src="/Uploads/<%= dtDataList.Rows[i]["medical_image"] %>" alt="" class="content-image" />
                        <div class="content-detail">
                            <div class="content-name">Name: <%= dtDataList.Rows[i]["medical_name"]%></div>
                            <div class="content-date">Date: <%= dtDataList.Rows[i]["medical_date"]%></div>
                            <div class="content-address">Address: <%= dtDataList.Rows[i]["medical_address"]%></div>
                            <div class="content-desc">Description: <%= dtDataList.Rows[i]["medical_content"]%></div>
                        </div>
                    </div>
                    <%
                }

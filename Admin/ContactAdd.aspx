<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactAdd.aspx.cs" Inherits="SchoolInfo.Admin.ContactAdd" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Contact Add</div>
        <div class="form-line">
            <div class="form-name">Image:</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUpdate.aspx.cs" Inherits="SchoolInfo.Admin.ContactUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Contact Update</div>
        <div class="form-line">
            <div class="form-name">Benefits Image:</div>
            <asp:FileUpload ID="txtUpload" class="form-upload" runat="server" />
        </div>
        <div class="form-line">
            <div class="form-name">Benefits Content:</div>

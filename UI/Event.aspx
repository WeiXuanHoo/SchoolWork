<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Event.aspx.cs" Inherits="SchoolInfo.UI.Event" %>
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="menu-list">
            <a class="menu-item menu-item-active" href="/UI/Index.aspx">Home</a>
    ...
    <!-- Common Title -->
    <div class="common-title">Coming Event</div>
            ...
            if (dtDataList != null)
            {
                for (int i = 0; i < dtDataList.Rows.Count; i++)
                {
                    ...
                    <div class="content-item">
                        <img src="/Uploads/<%= dtDataList.Rows[i]["event_image"] %>" alt="" class="content-image" />
                        <div class="content-detail">
                            <div class="content-name">Name: <%= dtDataList.Rows[i]["event_name"]%></div>
                            <div class="content-desc">Description: <%= dtDataList.Rows[i]["event_content"]%></div>
                        </div>
                    </div>
                    <%
                }
